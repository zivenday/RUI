...
import { addResizeListener, removeResizeListener } from 'recharger/src/utils/resize-event'
...
export default {
  ...
  render (h) {
    ...
    const scrollBtn = scrollable
      ? [
        <span class={['r-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled']} on-click={scrollPrev}><i class="el-icon-arrow-left"></i></span>,
        <span class={['r-tabs__nav-next', scrollable.next ? '' : 'is-disabled']} on-click={scrollNext}><i class="el-icon-arrow-right"></i></span>
      ] : null
    ...
    return (
      <div class={['r-tabs__nav-wrap', scrollable ? 'is-scrollable' : '', `is-${this.rootTabs.tabPosition}`]}>
        ...
        <div class={['r-tabs__nav-scroll']} ref="navScroll">
          <div class="r-tabs__nav" ref="nav" style={navStyle} role="tablist" on-keydown={changeTab}>
