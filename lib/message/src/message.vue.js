...
exports.default = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('transition', { attrs: { "name": "msgbox-fade" }, on: { "before-enter": _vm.beforeEnter, "after-leave": _vm.afterLeave } }, [_c('div', { directives: [{ name: "show", rawName: "v-show", value: _vm.showBox, expression: "showBox" }], staticClass: "r-message-box", on: { "touchmove": function touchmove($event) {
        ...
        } } }, [_c('div', { staticClass: "r-message-box__mask", class: { 'is-modal': _vm.options.hasModal }, on: { "touchstart": _vm.handleClose } }), _c('div', { staticClass: "r-message-box__body", class: { 'is-select': _vm.options.$type === 'input' || _vm.options.$type === 'confirm', 'is-waiting': _vm.options.$type === 'waiting' } }, [_vm.options.title ? _c('div', { staticClass: "r-message-box__title" }, [_vm._v(_vm._s(_vm.options.title))]) : _vm._e(), _vm.options.iconShow ? _c('div', { staticClass: "r-message-box__icon" }, [_c('r-icon', { attrs: { "name": _vm.options.iconClass } })], 1) : _vm._e(), _vm.options.message ? _c('div', { staticClass: "r-message-box__content", class: { 'is-select': _vm.options.$type === 'input' || _vm.options.$type === 'confirm' } }, [_vm._v(_vm._s(_vm.options.message))]) : _vm._e(), _vm.options.$type === 'input' ? _c('div', { staticClass: "r-message-box__input" }) : _vm._e(), _vm.options.$type === 'alert' || _vm.options.$type === 'tips' ? _c('div', { staticClass: "r-message-box__btn" }) : _vm._e(), _vm.options.$type === 'input' || _vm.options.$type === 'confirm' ? _c('div', { staticClass: "r-message-box__confirm" }, [_c('a', { on: { "click": _vm.handleCancel } }, [_vm._v("取消")]), _c('a', { on: { "click": _vm.handleConfirm } }, [_vm._v("确定")])]) : _vm._e(), _vm.options.$type === 'waiting' ? _c('span', { staticClass: "r-message-box__wait" }, [_c('svg', { attrs: { "viewBox": "25 25 50 50" } }, [_c('circle', { attrs: { "cx": "50", "cy": "50", "r": "20", "fill": "none" } })])]) : _vm._e()])])]);
  },
