...
var _dom = require('recharger/src/utils/dom');
...
!_vue2.default.prototype.$isServer && (0, _dom.on)(document, 'touchstart', function (e) {
  return startClick = e;
});
...
!_vue2.default.prototype.$isServer && (0, _dom.on)(document, 'touchend', function (e) {
  nodeList.forEach(function (node) {
    return node[ctx].documentHandler(e, startClick);
  });
});
